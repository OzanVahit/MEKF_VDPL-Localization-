...
function [Robot_ranges ranges angles lxa lya] = lidarkalman_olcum(posex, posey, pteta, map3, range_intervals,dmax,inc,angle_min,angle_max,kal_noise,Robot_ranges,olcum_noise)
...
Robot_ranges = l_robot + olcum_noise*randn(1,N);
...
Nl = 120; % Total number of VDPLs assigned to the map

nk = M/Nl;

Nm = 60; % The number of real measurements tasked with extracting the most appropriate virtual dynamic point landmarks (VDPL) assigned to the map.
